...
<head>
    ...
    <script src="/UNITOP/Backend/PHP/Exercise/ex23/shopping_cart/js/jquery-3.7.1.min.js"></script>
    <script src="/UNITOP/Backend/PHP/Exercise/ex23/shopping_cart/js/app.js"></script>
</head>
