                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php foreach ($_SESSION['cart']['buy'] as $item) { ?>
                                    <tr class="cart-item" data-id="<?php echo $item['id']; ?>">
                                        ...
                                        <td>
                                            <a href="?mod=product&act=detail&id=<?php echo $item['id']; ?>" title="<?php echo $item['product_title']; ?>" class="name-product">
                                                <?php echo $item['product_title']; ?>
                                            </a>
                                        </td>
                                        <td class="price"><?php echo fomatPrice($item['price']); ?></td>
                                        <td>
                                            <input type="number" name="qty[<?php echo $item['id']; ?>]" min="0" max="10"
                                                value="<?php echo $item['qty']; ?>" class="num-order" data-price="<?php echo $item['price']; ?>">
                                        </td>
                                        <td class="sub-total"><?php echo fomatPrice($item['sub_total']); ?></td>
                                        <td>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="7">
                                        <div class="clearfix">
                                            <p id="total_price" class="fl-right">Tổng giá: <span><?php echo fomatPrice(get_total_cart()); ?></span></p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
